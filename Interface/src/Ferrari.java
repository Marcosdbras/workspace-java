...
public class Ferrari implements Carro, ItemCaro {
	 ...
	 * Toda vez que utilizar interface eu devo implementar os métodos
	 * 
	 * Ao contrario de herança de classe a nossa classe pode implementar de diversas interface, 
	 * para isso basta separar os nomes da interface com vírgula
	 * 
	 * */
	
	
	/*
	 *Vem da classe Automóvel 
	 *
	 * */
